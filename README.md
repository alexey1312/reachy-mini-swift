...
produced locally — credentials never enter the repository or CI. The whole procedure, including the one-time
App Store Connect setup, is in [docs/release.md](docs/release.md).
